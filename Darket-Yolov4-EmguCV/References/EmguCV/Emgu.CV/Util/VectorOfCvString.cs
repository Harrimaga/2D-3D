...
namespace Emgu.CV.Util
{
   ...
   /// </summary>
   [Serializable]
   [DebuggerTypeProxy(typeof(VectorOfCvString.DebuggerProxy))]
   public partial class VectorOfCvString : Emgu.Util.UnmanagedObject, IInputOutputArray
   {
      ...
      {
        return new InputArray( cveInputArrayFromVectorOfCvString(_ptr), this );
      }
      ...
      {
         return new OutputArray( cveOutputArrayFromVectorOfCvString(_ptr), this );
      }
      ...
      {
         return new InputOutputArray( cveInputOutputArrayFromVectorOfCvString(_ptr), this );
      }     
      ...
      {
         private VectorOfCvString _v;

         public DebuggerProxy(VectorOfCvString v)
         {
            _v = v;
         }
...
#else
		 public CvString[] Values
         {
			get
			{
			   CvString[] result = new CvString[_v.Size];
      ...
      [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
      internal static extern IntPtr cveInputArrayFromVectorOfCvString(IntPtr vec);

      [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
      internal static extern IntPtr cveOutputArrayFromVectorOfCvString(IntPtr vec);

      [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
      internal static extern IntPtr cveInputOutputArrayFromVectorOfCvString(IntPtr vec);
   }
}
